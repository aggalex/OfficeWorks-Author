...
def create_toolbox(paned):
  ...
  toolstack = Gtk.Stack()
  toolstack.set_transition_type(Gtk.StackTransitionType.SLIDE_LEFT_RIGHT)
  toolstack.set_transition_duration(500)
  create_home_toolbox(toolstack)
  create_insert_toolbox(toolstack)
  ...
  HomeButton.connect("toggled", set_visible, toolstack, "home_toolbox")
  ...
  InsertButton.connect("toggled", set_visible, toolstack, "insert_toolbox")
...
def create_home_toolbox(ToolStack):
  toolbox = Gtk.VBox()
...
def create_insert_toolbox(ToolStack):
  toolbox = Gtk.VBox()
...
def create_pageview(paned):
  ...
  TextBuffer.set_text("Hellllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllo")
...
def set_visible(Widget, ToolStack, Toolbox):
